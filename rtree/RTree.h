...
public:
	...
	// Busca todas las entradas que se solapan con el rectángulo de búsqueda
	void Search(const Rect& searchRect, vector<vector<pair<int, int>>>& results);
...
protected:
	...
	void SearchRec(Node* a_node, const Rect& searchRect, vector<vector<pair<int, int>>>& results);
